module Pod
  ...
  class Config
    ...
    DEFAULTS = {
      ...
      :cache_root          => Pathname.new(Dir.home) + '.hcode',
    }
    ...
    #
    def home_dir
      @home_dir ||= Pathname.new(ENV['CP_HOME_DIR'] || '~/.hcode').expand_path
    end

    # @return [Pathname] the directory where the CocoaPods sources are stored.
    #
    def repos_dir
      @repos_dir ||= Pathname.new(ENV['CP_REPOS_DIR'] || '~/.hcode/repos').expand_path
    end
    ...
    #
    def templates_dir
      @templates_dir ||= Pathname.new(ENV['CP_TEMPLATES_DIR'] || '~/.hcode/templates').expand_path
    end
